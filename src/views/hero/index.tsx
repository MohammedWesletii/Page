    ...
    <div className={styles.hero}>
      <Container>
        <div className={styles.hero_top}>
          <div>
            <h1>
            WEB3 Launch Redpacks Reward  <br />
              Find Out Why, Claim Your Massive Reward
            </h1>
            <div className={styles.trade_btc_free}>
              <Icon icon={'gift'} width={24} height={24} fill='#F0B90B' />
              <span>Revolutionary way to connect and reward with our innovative Web3 Section</span>
              <Icon icon={'chevronRight'} width={16} height={16} fill='#929AA5' />
            </div>

            <div className={styles.buttons}>
              <Button title='Sign in to your Web3 wallet' variant='primary' mt={16} icon='user' iconWidth={17} iconHeight={16} fullWidth={true} />
